...
2. **Claude, in ordine post-call**: (1) esplorare il codice di Enrico appena c'è il link (mappare vs i nostri script: cosa riusare, cosa migliorare); (2) rifare i nostri esperimenti chiave DENTRO la loro pipeline sul dataset 120 cm (naming nuovo, Excel compilato); (3) script derivazione 60 cm (aggregazione 2×2 da 30 cm, media — con controllo letteratura come da Thomas); (4) migrare la valutazione WSOL nel loro flusso (evaluation notebook ha già visualize-CAM); (5) skill automation-recommender per hook/regole di lavoro (richiesta esplicita Ale 24/7 — primo task dopo il compact).
