...
1. **Attese esterne**: (a) link GitLab da Enrico (in giornata 24/7) → clone della branch "Alessandro Potenza" su eagle `/home/dev`; (b) dataset 30 cm (Thomas avvisa, ~settimana prossima); (c) chiarire **VNIR vs FS** nell'Excel (probabile prima domanda a Enrico).
