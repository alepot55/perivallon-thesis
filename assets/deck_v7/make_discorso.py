# -*- coding: utf-8 -*-
"""Discorso per deck v7 (28 slide). HTML -> PDF via wkhtmltopdf."""
...
(14,"Alari: risultati per materiale",
 ...
 "E cosa lasciano aperto le sue conclusioni."),
(15,"Alari: conclusioni aperte",
 "Le conclusioni della tesi elencano cinque direzioni future, e le riporto perché definiscono i gap dal punto di vista di chi ha fatto il lavoro. Uno: estendere il dataset, perché 5 classi su 13 hanno meno di 400 campioni. Due: immagini multi- e iperspettrali, indicate testualmente come potenzialmente utili per identificare i tipi di rifiuto. Tre: augmentation sintetica contro le co-occorrenze. Quattro: pre-training multi-classe, oggi infattibile con meno di 300 immagini a etichetta singola. Cinque: object detection, al costo di nuove annotazioni. Il punto due è questa tesi; i punti uno e tre spiegano parte del crollo per classe visto prima.",
 "Gap presi dalle conclusioni della tesi, non inventati. Punto 2 = la nostra direzione, dichiarata dall'autore stesso.",
...
(18,"Asbestos weathering in VNIR",
...
QA=[
("Perché Alari è il riferimento principale?","Non lo è a priori: è entrato in libreria con lo stesso screening degli altri paper. Emerge dalla tabella di copertura come unico lavoro multi-materiale in scope, e per questo è il confronto operativo. E le sue stesse conclusioni indicano l'estensione multispettrale come lavoro futuro: la direzione di questa tesi."),
...
TIPS=[
"28 slide, ~22 minuti. Presentazione in italiano, termini tecnici in inglese.",
...
"Le slide di analisi (11-15, 17-18, 20) sono il cuore: i lavori chiave letti a fondo, con i numeri per classe e per banda.",
"Slide 22 (sintesi) e le tabelle: passarci veloci, non rileggerle riga per riga.",
...
parts.append("<h1>Discorso — deck v7 (28 slide)</h1>")
