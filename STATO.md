...
4. ~~Prenotazione GPU + sanity-training~~ ✅ **partito 21/7 sera**: slot prenotati sul foglio Turni ("Waste (Ale)", eagle GPU 1: mar 22-24 + mer 10-12), training lanciato in tmux (`~/experiments/sanity_binary_pneo.py`, ResNet-50 RGB, 0.3m poi 1.2m, 5 epoche). Risultati → `EXPERIMENTS_LOG.md`.
