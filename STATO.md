...
3. **Claude, in corso/coda**: (1) ~~doc-baseline Gibellini~~ ✅ 21/7; (2) mini-SOTA WSOL/WSSS **in corso** (agente su web + Mazzola); (3) indice tesi v0 dopo il verdetto mini-SOTA; (4) related work detection (riorienta `docs/02_research/loop_prof_sota/10_related_work_draft.md`); (5) tenere vivi `EXPERIMENTS_LOG.md` + `CLAIMS.md`.
4. **Dopo la call**: prenotare slot GPU (foglio Turni) e lanciare il primo sanity-training sugli split `Thomas/0.3m` entro dom 26/7.
