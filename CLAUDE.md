...
- **Bozze messaggi (Teams/mail per Thomas, Enrico, prof)**: brevi, semplici, cortesi, tono naturale da telefono — niente elenchi, niente em dash, niente formattazione o struttura; spesso spezzati in più invii. Esempi reali e fatti dalla chat: `docs/00_context/chat_thomas_log.md`.
